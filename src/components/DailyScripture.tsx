...
export default function DailyScripture({ onOpenSettings }: Props = {}) {
  ...
  return (
    <div className="card flex flex-col gap-0 h-full relative overflow-hidden animate-fade-up delay-3">
